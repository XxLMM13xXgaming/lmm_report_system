LMMRSConfig = {}
LMMRSConfig.DevMode = false
/*
*/
LMMRSConfig.AdminGroups = {"owner", "superadmin", "admin"}

LMMRSConfig.PlayerReportReasons = {"RDM", "FailRP", "Mic Spam", "Prop Spam", "Minge", "Troll"} -- Do not add a other option!
